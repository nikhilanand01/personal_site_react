        ...
        return (
            <div className="condiv">
              ...
              <div style={{display: 'flex', flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-evenly'}}>
                ...
                <ProjectCard image={billi} label="Data Analysis" category="R"  projectName="Top 10?" description="Predicting Billboard Hot 100 Top 10 Songs"/>
                ...
                <ProjectCard image={fud} label="Mobile App" category="Swift"  projectName="fud" description="App to lower food waste with discounts"/>
                <ProjectCard image={lboard} label="Mobile App" category="React Native"  projectName="LBoard" description="App to share embarssing moments with friends"/>
              </div>
            </div>
            )
        }
